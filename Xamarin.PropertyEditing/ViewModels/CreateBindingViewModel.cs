...
namespace Xamarin.PropertyEditing.ViewModels
{
		...
		: PropertiesViewModel, IProvidePath
	{
			...
			: base (platform)
		{
			...
			this.OSPlatform = Environment.OSVersion.Platform;
		...
		public BindingSource SelectedBindingSource
		{
			...
			set
			{
				...
				((RelayCommand)RequestAddValueConverter)?.ChangeCanExecute ();
			}
		}
		...
		public readonly PlatformID OSPlatform;
		...
		public ICommand RequestAddValueConverter => this.requestAddValueConverterCommand;
